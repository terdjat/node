...
<html lang="ar" dir="rtl" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <title>موقع الأستاذ ترجات للرياضيات</title>
...
<link href="assets/css/bootstrap.rtl.min.css" rel="stylesheet">
    ...
    <link href="assets/css/cheatsheet.rtl.css" rel="stylesheet">
  </head>
...
<header class="bd-header bg-dark py-3 d-flex align-items-stretch border-bottom border-dark">
  <div class="container-fluid d-flex align-items-center">
    <h1 class="d-flex align-items-center fs-4 text-white mb-0">
      <img src="assets/img/sigle.jpg" width="38" height="30" class="me-3" alt="Bootstrap">
      موقع الأستاذ ترجات للرياضيات
    </h1>
...
- ما من عبدٍ يقولُ في صباحِ كلِّ يومٍ ومساءِ كلِّ ليلةٍ بسمِ اللَّهِ الَّذي لا يضرُّ معَ اسمِهِ شيءٌ في الأرضِ ولا في السَّماءِ وَهوَ السَّميعُ العليمُ ثلاثَ مرَّاتٍ إلا لم يضرَّهُ شيءٌ
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
          <div class="container-fluid">
            <a class="navbar-brand" href="#">
              <img src="assets/img/tj.jpg" width="38" height="30" class="d-inline-block align-top" alt="Bootstrap" loading="lazy"
...
<script src="assets/js/bootstrap.bundle.min.js"></script>
    ...
    <script src="assets/js/cheatsheet.js"></script></body>
</html>
